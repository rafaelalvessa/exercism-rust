...
#[test]
fn test_clock_from_string() {
    assert_eq!(Clock::new(0, 0), Clock::from(String::from("00:00")));
}

#[test]
#[should_panic(expected = "The time must use the HH:MM format.")]
fn test_clock_from_string_with_invalid_format() {
    Clock::from(String::from("00:00:00"));
}

#[test]
#[should_panic(expected = "The hours must be a value in the range 00-24.")]
fn test_clock_from_string_with_invalid_hours() {
    Clock::from(String::from("99:00"));
}

#[test]
#[should_panic(expected = "The hours must be a value in the range 00-24.")]
fn test_clock_from_string_with_invalid_negative_hours() {
    Clock::from(String::from("-99:00"));
}

#[test]
#[should_panic(expected = "The minutes must be a value in the range 00-59.")]
fn test_clock_from_string_with_invalid_minutes() {
    Clock::from(String::from("24:99"));
}

#[test]
#[should_panic(expected = "The minutes must be a value in the range 00-59.")]
fn test_clock_from_string_with_invalid_negative_minutes() {
    Clock::from(String::from("24:-99"));
}
